 ...
 <nav id="navbar">
    <!-- 5개의 메뉴생성 -->
      <ul>
        ...
        <li class="nav-item logo"><a href="${pageContext.request.contextPath}/"><img src="${pageContext.request.contextPath}/resources/images/logo.jpg" alt="로고입니다." ></a></li>
       <li class="nav-item"> <a href="${pageContext.request.contextPath}/personal/personal">개인</a></li>
        <li class="nav-item"><a href="${pageContext.request.contextPath}/busines">기업</a></li>
